Public Class clsTab9
    ...
    Public Overrides Function ToString() As String
        ...
        tab = New HtmlTable(9, "<tr><td width=""90%"" align=""left"" bgcolor=""white"" color=""black"">4. Busverkehr wegen zersplitterter Siedlungsstruktur nicht zu ersetzen</td><td width=""10%"" align=""middle"" rowspan=""2"" style=""border: 1px solid black;"">" & resultat & "</td></tr>")
