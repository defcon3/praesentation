Public Class clsTab17
    ...
    Public Overrides Function ToString() As String
        ...
        tab = New HtmlTable(17, "<tr><td width=""100%"" height=""100%"" align=""center"" bgcolor=""white"" color=""black""><br></br><img src=""" & resultat & """ alt=""Mein Bild""  style=""max-width: 100%; max-height: 100%;""></td><td width=""10%"" align=""middle"" rowspan=""1"" border=""1"" bordercolor=""black"">" & "" & "</td></tr>")
