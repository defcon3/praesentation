Public Class clsTab8
    ...
    Public Overrides Function ToString() As String
        ...
        tab = New HtmlTable(nummer, "<tr><td width=""90%"" align=""left"" bgcolor=""white"" color=""black""></td><td width=""10%"" align=""middle"" rowspan=""2"" style=""border: 1px solid black;"">" & wert & "</td></tr>")
