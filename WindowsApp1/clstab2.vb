Public Class clsTab2
    ...
    Public Overrides Function ToString() As String
        ...
        tab = New HtmlTable(2, "<tr><th width=""20%"" align=""left"" bgcolor=""white"" color=""blue"">Verkehrspotenzial</th><th width=""80%"" align=""left"">______________________________________________________________________________________________________</th></tr>")
        If nummer = 5 Then
